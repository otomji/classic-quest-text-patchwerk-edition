...
local qf_doprog2 = 0
local qf_done = 1
local sounds = {"567445", "567503", "567396"}
local currentqid = 0
local currentqm = 0
...
config_frame.text0 = config_frame:CreateFontString(nil, "OVERLAY")
...
config_frame.text1 = config_frame:CreateFontString(nil, "OVERLAY")
...
config_frame.text2 = config_frame:CreateFontString(nil, "OVERLAY")
...
config_frame.text3 = config_frame:CreateFontString(nil, "OVERLAY")
